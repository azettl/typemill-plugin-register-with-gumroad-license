...
namespace Plugins\registergumroad;
...
class RegisterGumroad extends Plugin
{
	...
	{
		return [
			['httpMethod' => 'get', 'route' => '/tm/register', 'class' => 'Plugins\RegisterGumroad\RegisterGumroad:showRegistrationForm', 'name' => 'register.show'],
			['httpMethod' => 'post', 'route' => '/tm/register', 'class' => 'Plugins\RegisterGumroad\RegisterGumroad:createUser', 'name' => 'register.create'],
			['httpMethod' => 'get', 'route' => '/tm/registerhoney', 'class' => 'Plugins\RegisterGumroad\RegisterGumroad:showHoneypot', 'name' => 'register.honeypot'],
			['httpMethod' => 'get', 'route' => '/tm/registerwelcome', 'class' => 'Plugins\RegisterGumroad\RegisterGumroad:showWelcome', 'name' => 'register.welcome'],
			['httpMethod' => 'get', 'route' => '/tm/registeroptin', 'class' => 'Plugins\RegisterGumroad\RegisterGumroad:optin', 'name' => 'register.optin'],
			['httpMethod' => 'get', 'route' => '/tm/registeremail', 'class' => 'Plugins\RegisterGumroad\RegisterGumroad:requestConfirmationEmail', 'name' => 'register.requestemail'],
			['httpMethod' => 'post', 'route' => '/tm/registeremail', 'class' => 'Plugins\RegisterGumroad\RegisterGumroad:sendConfirmationEmailAgain', 'name' => 'register.sendemail'],
		];
	}
	...
	public function showRegistrationForm($request, $response, $args)
	{
		...
		$this->addCSS('/registergumroad/css/register.css');
		...
		if(isset($settings['plugins']['registergumroad']['recaptcha']) && $settings['plugins']['registergumroad']['recaptcha_webkey'] != '')
		{
			$recaptcha_webkey = $settings['plugins']['registergumroad']['recaptcha_webkey'];
		}
	...
	public function createUser($request, $response, $args)
	{
		...
		curl_setopt(
			...
			CURLOPT_POSTFIELDS,
			"product_permalink=" 
				. $settings['plugins']['registergumroad']['gumroadpermalink'] 
		...
		if(isset($settings['plugins']['registergumroad']['userrole']) && $settings['plugins']['registergumroad']['userrole'] != '')
		{
			$params['userrole'] = $settings['plugins']['registergumroad']['userrole'];
		}
		...
		if($validate->newUser($params, $userroles))
		{
			...
			if($username)
			{
				...
				if(isset($settings['plugins']['registergumroad']['notifyafterregistration']) && $settings['plugins']['registergumroad']['notifyafterregistration'])
				{
	...
	protected function sendConfirmationEmail($settings, $userdata, $base_url)
	{
		...
		if(isset($this->container['mail']))
		{
			...
			$body1 		= $settings['plugins']['registergumroad']['mailsalutation'] . " " . $username . ",";
			$body2 		= "\n\n" . $settings['plugins']['registergumroad']['mailbeforelink'];
			...
			$body4 		= "\n\n" . $settings['plugins']['registergumroad']['mailafterlink'];
			...
			$mail->addReplyTo($settings['plugins']['registergumroad']['mailreplyto'], $settings['plugins']['registergumroad']['mailreplytoname']);
			$mail->setSubject($settings['plugins']['registergumroad']['mailsubject']);
	...
	private function checkCaptcha($params, $settings)
	{
		if(isset($params['g-recaptcha-response']))
		{
			...
			$secret				= isset($settings['plugins']['registergumroad']['recaptcha_secretkey']) ? $settings['plugins']['registergumroad']['recaptcha_secretkey'] : false;
	...
	public function optin($request, $response, $args)
	{
		...
		if(isset($settings['plugins']['registergumroad']['notifyafterconfirmation']) && $settings['plugins']['registergumroad']['notifyafterconfirmation'])
		{
	...
	protected function sendRegisterNotification($settings, $userdata)
	{
		...
		if(isset($this->container['mail']))
		{
			...
			$mail->addAdress($settings['plugins']['registergumroad']['mailreplyto']);
